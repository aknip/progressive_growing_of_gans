...
def train_progressive_gan(
    ...
    resume_run_id           = 2, # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = None,         # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 950.0,          # Assumed training progress at the beginning. Affects reporting and training schedule.
