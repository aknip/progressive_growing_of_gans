...
#tf_config['gpu_options.allow_growth']          = False     # False (default) = Allocate all GPfffffffffffffffffffffffffffffffU memory at the beginning. True = Allocate only as much GPU memory as needed.
