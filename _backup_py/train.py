...
def train_progressive_gan(
    ...
    resume_run_id           = './results/000-pgan-celeba-preset-v2-1gpu-fp32/network-snapshot-002705.pkl',         # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = None,         # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 2705.9,          # Assumed training progress at the beginning. Affects reporting and training schedule.
